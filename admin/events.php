                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Events Details
                                            <a href="events-create.php" class="btn btn-primary float-end">Add details</a>
                                        </h4>
                                    </div>
                                                    ...
                                                    if(mysqli_num_rows($query_run) > 0)
                                                    {
                                                        foreach($query_run as $details)
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $details['email']; ?></td>
                                                                <td><?= $details['events']; ?></td>
                                                                <td>
                                                                    <a href="events-view.php?id=<?= $details['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                                    <a href="events-edit.php?id=<?= $details['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                                    <form action="events-code.php" method="POST" class="d-inline">
                                                                        <button type="submit" name="delete_details" value="<?=$details['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                                    </form>
                                                                </td>
                                                            </tr>
                                                            <?php
